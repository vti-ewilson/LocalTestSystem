...
{
    /// <summary>
    /// This class assists with switching the language on an existing form.
    /// </summary>
    public class FormLanguageSwitchSingleton
    {
        ...
        /// </summary>
        protected static readonly FormLanguageSwitchSingleton _instance = new FormLanguageSwitchSingleton();

        /// <summary>
        ///     Hidden constructor called during static member <c>_instance</c>
        ///     initialization.
        /// </summary>
        ...
        {
            object newValue = resources.GetObject(name, _cultureInfo);
            if (newValue == null)
            {
        ...
        private void SetProperty(System.Windows.Forms.Control control, string propertyName, System.Resources.ResourceManager resources)
        {
            try
            {
                ...
                if (propertyInfo != null)
                {
                    ...
                    if (control is System.Windows.Forms.Form)
                        controlName = "$this";
                    object resObject = resources.GetObject(controlName + "." + propertyName, _cultureInfo);
                    if (resObject != null)
        ...
        private void ReloadTreeViewNodes(System.Windows.Forms.TreeView treeView, System.Resources.ResourceManager resources)
        {
            if (treeView.Nodes.Count > 0)
            {
                ...
                newNodes[0] = (System.Windows.Forms.TreeNode)resources.GetObject(resourceName, _cultureInfo);
                ...
                {
                    newNodes[i] = (System.Windows.Forms.TreeNode)resources.GetObject(resourceName + i.ToString(), _cultureInfo);
                }
        ...
        private void ReloadItems(string controlName, IList list, int itemsNumber, System.Resources.ResourceManager resources)
        {
            ...
            object obj = resources.GetString(resourceName, _cultureInfo);
            // VS2002 generates item resource name with additional ".Items" string
            if (obj == null)
            {
                resourceName += ".Items";
                obj = resources.GetString(resourceName, _cultureInfo);
            }
            if (obj != null)
            {
                list.Clear();
                ...
                for (int i = 1; i < itemsNumber; i++)
                    list.Add(resources.GetString(resourceName + i, _cultureInfo));
            }
        }
    ...
    /// <summary>
    /// Form language helper class
    /// </summary>
    public static class FormLanguageExtensions
    {
        /// <summary>
        /// Changes the language of the <c>Form</c> to the currently selected language.
        /// </summary>
        /// <param name="Value">Form object to apply changes to.</param>
        public static void ChangeLanguage(this Form Value)
        {
            System.Globalization.FormLanguageSwitchSingleton.Instance.ChangeLanguage(Value);
        }
    }
}