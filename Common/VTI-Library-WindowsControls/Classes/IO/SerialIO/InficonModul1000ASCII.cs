...
{
    /// <summary>
    /// Implements the binary communication protocol to an Inficon Modul 1000 Leak Detector
    /// </summary>
    public partial class InficonModul1000ASCII : SerialIOBase
    {
        #region Enums
...
#pragma warning restore 1591
        ...
        public Boolean _StartLD = false;
        public Boolean _StopLD = false;
        public Boolean _VentLD = false;
        ...
        public InficonModul1000ASCII(IContainer container)
        {
            container.Add(this);
        ...
        public override void Process()
        {
            ...
            try
            {
                ...
                if (this.IsAvailable)
                {
                    ...
                    {
                        tempstring = serialPort1.ReadLine();
                        forelinepress = Convert.ToDouble(tempstring);
                    }
                    catch (Exception e)
                    {
                        //commError = true;
            ...
            try
            {
                ...
                if (this.IsAvailable)
                {
                    try
                    {
                        _LDSStatus = serialPort1.ReadLine();
                        //{
                        //    Actions.WaitForUpTo(50, () => this.serialPort1.BytesToRead > 0);
        ...
        /// <summary>
        /// Starts the Modul 1000. Evacuates, then crossover to LD
        /// </summary>
        public bool StartLD()
        {
            if (!_DoNotCall)
        ...
        /// <summary>
        /// Stops the Modul 1000. Modul 1000 must be stopped before venting
        /// </summary>
        public bool StopLD()
        {
            if (!_DoNotCall)
        ...
        {
            get { return "Inficon Modul 1000 Leak Detector on port " + this.SerialPort.PortName; }
        }
