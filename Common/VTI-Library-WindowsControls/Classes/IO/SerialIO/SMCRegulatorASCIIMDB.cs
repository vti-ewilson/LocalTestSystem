...
namespace VTIWindowsControlLibrary.Classes.IO.SerialIO
{
    ...
    /// </summary>
    public partial class SMCRegulatorANSIIMDB : SerialIOBase
    {
        #region Enums
...
#pragma warning restore 1591
        ...
        private String SMCITVSetPointValue = "0";

        //private String SMCITVSetPointPressure;
        private Boolean _DoNotCall;

        private String _Units = "cc/s";
        ...
        public SMCRegulatorANSIIMDB(IContainer container)
        {
            container.Add(this);
        ...
        public override void Process()
        {
            ...
            //    Actions.WaitForUpTo(3000, () => this.serialPort1.BytesToRead > 20);
            ...
            //                String[] StringSep=new String[3];
            //                StringSep[0]="\r";
            //                StringSep[1]="\n";
            //                //StringSep[2]="\";
            //                StringArray = tempstring.Split(StringSep,3,System.StringSplitOptions.None);
            //                leakRate = Convert.ToDouble(StringArray[1]);
        ...
        {
            get { return "SMC Regulator on port " + this.SerialPort.PortName; }
        }
        ...
        /// <summary>
        /// Gets or sets the value of the ITV Set Point 0-1023
        /// </summary>
        public String SMCITVSetPoint
        {
            get { return SMCITVSetPointValue; }

            set
            {
                SMCITVSetPointValue = value;
                //Debug.WriteLine("SMCITVSetPointValue set to " + SMCITVSetPointValue);
            }
        }

        //public Int16 SMCTargetPressure
        //{
        //  set { SMCITVSetPointPressure = value; }
        ...
        public bool SetSMCITVSetPoint
        {
            get
            {
                //Debug.WriteLine("_DoNotCall = " + _DoNotCall);
                if (!_DoNotCall)
                {
                    _DoNotCall = true;
                    Thread.Sleep(50);
                    ...
                    string TempCmd;
                    serialPort1.DiscardInBuffer();
                    TempCmd = string.Format("SET {0}", SMCITVSetPointValue.ToString());
                    serialPort1.WriteLine(TempCmd);
                    //Debug.WriteLine(TempCmd);
                    //serialPort1.WriteLine("REQ");
                    Thread.Sleep(800);
                    if (this.IsAvailable)
                    {
                        try
                        {
                            Actions.WaitForUpTo(800, () => this.serialPort1.BytesToRead > 0);
                            {
                                _DoNotCall = false;

                                string returnStrin;
                                returnStrin = serialPort1.ReadExisting();
                                //Console.WriteLine(returnStrin);
                                return true;
                            }
                        }
                        catch (Exception e)
