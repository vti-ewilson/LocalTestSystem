...
{
    /// <summary>
    /// Serial Interface for an Messkonzept FTC130 Helium Purity Monitor
    /// </summary>
    public partial class MesskonzeptFTC130 : SerialIOBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MesskonzeptFTC130">MesskonzeptFTC130</see> class
        /// </summary>
        public MesskonzeptFTC130()
        {
            InitializeComponent();
        ...
        /// Initializes a new instance of the <see cref="MesskonzeptFTC130">MesskonzeptFTC130</see> class
        /// </summary>
        public MesskonzeptFTC130(IContainer container)
        {
            container.Add(this);
        ...
        /// Initializes a new instance of the <see cref="MesskonzeptFTC130">MesskonzeptFTC130</see> class
        /// </summary>
        public MesskonzeptFTC130(SerialPortParameter SerialPortParameter)
        {
            InitializeComponent();
            this.serialPort1.BaudRate = 19200;
        ...
        /// <summary>
        /// Thread for reading the PPM of the MesskonzeptFTC130 Purity Monitor
        /// </summary>
        public override void Process()
        {
            ...
            if (Monitor.TryEnter(this.SerialLock, 1500))
            {
                try
                {
                    ...
                    {
                        retVal = ProcessCommandAndReturnValue("P39=F22");
                    ...
                    {
                        retVal = ProcessCommandAndReturnValue("P39=F21");
                        startedCalibration = true;
                    ...
                    {
                        retVal = ProcessCommandAndReturnValue($"P61=F{_setGainTo.ToString("E4")}");
                        _setGain = false;
                        return;
                    }
                    else if (_getGain)
                    {
                        retVal = ProcessCommandAndReturnValue("P61?");
                        readGain = true;
                    }
                    else if (_setOffset)
                    {
                        retVal = ProcessCommandAndReturnValue($"P60=F{_setOffsetTo.ToString("E4")}");
                        _setOffset = false;
                        return;
                    }
                    else if (_getOffset)
                    {
                        retVal = ProcessCommandAndReturnValue("P60?");
                        readOffset = true;
                    }
                    else 
                    {
                        retVal = ProcessCommandAndReturnValue("P0?");
                    }
        ...
        /// <summary>
        /// Name for the MesskonzeptFTC130 Controller
        /// </summary>
        public override string Name
        {
            get { return "MesskonzeptFTC130 on port " + serialPort1.PortName; }
        }

        /// <summary>
        /// RawValue (Voltage) from the MesskonzeptFTC130 Controller
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Minimum value for the MesskonzeptFTC130 Controller
        /// </summary>
        /// <value>1.0E-3</value>
        ...
        /// <summary>
        /// Maximum value for the MesskonzeptFTC130 Controller
        /// </summary>
        /// <value>1.0E3</value>
        ...
        /// <summary>
        /// Units for the value for the MesskonzeptFTC130 Controller
        /// </summary>
        /// <value>torr</value>
        ...
        /// <summary>
        /// Format string for the value for the MesskonzeptFTC130 Controller
        /// </summary>
        ...
        /// <summary>
        /// Value (pressure) for the MesskonzeptFTC130 Controller
        /// </summary>
