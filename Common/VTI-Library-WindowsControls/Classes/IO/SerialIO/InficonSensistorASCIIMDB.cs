...
namespace VTIWindowsControlLibrary.Classes.IO.SerialIO
{
    ...
    /// </summary>
    public partial class InficonSensistorANSIIMDB : SerialIOBase
    {
        #region Enums
...
#pragma warning restore 1591
        ...
        private Boolean _SetDetectionMode;
        ...
        /// </summary>
        public InficonSensistorANSIIMDB()
        {
            InitializeComponent();
            Init();
        }
        ...
        public InficonSensistorANSIIMDB(IContainer container)
        {
            container.Add(this);
        ...
        public override void Process()
        {
            ...
            if (_SetDetectionMode)
            {
                _SetDetectionMode = false;
        ...
        public bool SetDetectionMode
        {
            get { return _SetDetectionMode; }
            set { _SetDetectionMode = value; }
        }
        ...
        {
            get { return "Inficon Sensistor Leak Detector on port " + this.SerialPort.PortName; }
        }
