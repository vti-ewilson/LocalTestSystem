...
namespace VTIWindowsControlLibrary.Classes.IO.SerialIO
{
    ...
    /// </summary>
    public partial class InficonLDS3000ANSIIMDB : SerialIOBase
    {
        #region Enums
...
#pragma warning restore 1591
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InficonLDS3000ANSIIMDB">InficonLDS3000ANSIIMDB</see> class
        /// </summary>
        public InficonLDS3000ANSIIMDB()
        {
            InitializeComponent();
            Init();
        }
        ...
        public InficonLDS3000ANSIIMDB(IContainer container)
        {
            container.Add(this);
        ...
        /// <summary>
        /// When called, this method invokes the <see cref="InficonLDS3000ANSIIMDB.OnValueChanged">OnValueChanged</see>
        ...
        {
            get { return "Inficon LDS3000 Leak Detector on port " + this.SerialPort.PortName; }
        }
