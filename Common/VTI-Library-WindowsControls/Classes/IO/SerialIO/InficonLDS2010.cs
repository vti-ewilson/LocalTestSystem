...
namespace VTIWindowsControlLibrary.Classes.IO.SerialIO
{
    ...
    /// </summary>
    public partial class InficonLDS2010 : PfeifferInterface
    {
        #region Enum
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InficonLDS2010">InficonLDS2010</see>
        /// </summary>
        public InficonLDS2010()
        {
            InitializeComponent();
            Init();
        }
        ...
        public InficonLDS2010(IContainer container)
        {
            container.Add(this);
        ...
        {
            get { return "Inficon LDS2010 Leak Detector on port " + this.SerialPort.PortName + " with ID " + this.Address; }
        }
