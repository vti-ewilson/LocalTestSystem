...
{
    /// <summary>
    /// Serial Interface for an OptimaOP909Scale
    /// </summary>
    public class OptimaOP909Scale : SerialIOBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimaOP909Scale">OptimaOP909Scale</see> class
        /// </summary>
        ...
        public OptimaOP909Scale(int Decimals, String Units)
            : base()
        {
            _decimals = Decimals;
            _units = Units;
        ...
        /// <summary>
        /// Thread for reading the <see cref="Value">Value</see> (position) of the OptimaOP909Scale
        /// </summary>
        public override void Process()
        {
            ...
            if (Monitor.TryEnter(this.SerialLock, 500))
            {
                try
                {
                    serialPort1.Write(String.Format("P"));//("{0}P", (char)27));
                    while (!s.Contains("lb"))
                    {
                    ...
                    if (s.Contains("lb"))
                    {
                        string ss = Regex.Match(s, @"\d+").Value;
                        _weight = Convert.ToSingle(ss);
                        _weightReady = true;
        ...
        /// <summary>
        /// Name for the OptimaOP909Scale
        /// </summary>
        public override string Name
        {
            get { return "Optima Scale Controller on port " + this.PortName; }
        }
        ...
        /// <summary>
        /// Minimum value of the OptimaOP909Scale
        /// </summary>
        ...
        /// <summary>
        /// Maximum value of the OptimaOP909Scale
        /// </summary>
        ...
        /// <summary>
        /// Units for the OptimaOP909Scale
        /// </summary>
        ...
        /// <summary>
        /// String format for displaying the value of the OptimaOP909Scale
        /// </summary>
