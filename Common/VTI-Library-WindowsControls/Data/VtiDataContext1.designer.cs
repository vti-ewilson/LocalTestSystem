...
namespace VTIWindowsControlLibrary.Data
{
    ...
    public partial class UutRecord : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        public virtual void AddDetailUnsafe(CycleStep step, AnalogSignal processSignal, int digitsToRoundSignal, NumericParameter minLimit, NumericParameter maxLimit)
        {
            try
            {
                ...
                string strMinSetpointName = minLimit != null ? minLimit.DisplayName : string.Empty;
                string strMaxSetpointName = maxLimit != null ? maxLimit.DisplayName : string.Empty;
                string strUnits = "";
                if (minLimit != null)
                {
                    strUnits = minLimit.Units;
                }
                else if (maxLimit != null)
                {
                    strUnits = maxLimit.Units;
                }
                ...
                UutRecordDetails.Add(
                    new UutRecordDetail
                    {
                        ...
                        MinSetpoint = minLimit != null ? minLimit.ProcessValue : 0,
                        MaxSetpointName = strMaxSetpointName,
                        MaxSetpoint = maxLimit != null ? maxLimit.ProcessValue : 0,
                        Units = strUnits,
        ...
        public virtual void AddDetailUnsafe(string UutDetailTestName, double doubleValue, int digitsToRoundValue, string valueName, string units, double minLimit, string minLimitName, double maxLimit, string maxLimitName, double elapsedTime, CycleStepState cycleStepState)
        {
            try
            {
                string strTest = UutDetailTestName;
                string strResult = cycleStepState.ToString();
                string strValueName = valueName;
                string strMinSetpointName = minLimitName;
                string strMaxSetpointName = maxLimitName;
                ...
                this.UutRecordDetails.Add(
                    new UutRecordDetail
                    {
                        ...
                        Result = strResult,
                        ValueName = strValueName,
                        Value = Double.IsNaN(doubleValue) ? 0 : Math.Round(doubleValue, digitsToRoundValue),
                        MinSetpointName = strMinSetpointName,
                        MinSetpoint = minLimit,
                        MaxSetpointName = strMaxSetpointName,
                        MaxSetpoint = maxLimit,
                        Units = strUnits,
            ...
            {
                VtiEvent.Log.WriteError("Error adding UutRecordDetail: " + ee.Message);
            }
        }

        public virtual void AddDetailUnsafe(string UutDetailTestName, string stringValue, string valueName, double elapsedTime, CycleStepState cycleStepState)
        {
            try
            {
                string strTest = UutDetailTestName;
                ...
                string strValueName = valueName;
                string strMinSetpointName = string.Empty;
                string strMaxSetpointName = string.Empty;
                string strUnits = "";
                LeftStr(ref strTest, 50); // UutRecordDetails limits this to 50 test characters
                LeftStr(ref strResult, 50);
                LeftStr(ref strValueName, 50);
    ...
    public static class UutRecordExtensions
    {
        public static void AddDetail(this UutRecord uutRecord, CycleStep step, AnalogSignal processSignal, int digitsToRoundSignal, NumericParameter minLimit, NumericParameter maxLimit)
        {
            if (uutRecord != null)
            {
                uutRecord.AddDetailUnsafe(step, processSignal, digitsToRoundSignal, minLimit, maxLimit);
            }
        }
        public static void AddDetail(this UutRecord uutRecord, string UutDetailTestName, double doubleValue, int digitsToRoundValue, string valueName, string units, double minLimit, string minLimitName, double maxLimit, string maxLimitName, double elapsedTime, CycleStepState cycleStepState)
        {
            if (uutRecord != null)
            {
                uutRecord.AddDetailUnsafe(UutDetailTestName, doubleValue, digitsToRoundValue, valueName, units, minLimit, minLimitName, maxLimit, maxLimitName, elapsedTime, cycleStepState);
            }
        }
        public static void AddDetail(this UutRecord uutRecord, string UutDetailTestName, string stringValue, string valueName, double elapsedTime, CycleStepState cycleStepState)
        {
            if (uutRecord != null)
            {
                uutRecord.AddDetailUnsafe(UutDetailTestName, stringValue, valueName, elapsedTime, cycleStepState);
            }
        }
    }
