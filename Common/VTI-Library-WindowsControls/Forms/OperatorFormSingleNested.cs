...
namespace VTIWindowsControlLibrary.Forms
{
    ...
    /// </summary>
    public partial class OperatorFormSingleNested : Form
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OperatorFormSingleNested">OperatorFormSingleNested</see> class
        /// </summary>
        /// <param name="MdiParent">Form that will be the owner of this form</param>
        public OperatorFormSingleNested(Form MdiParent)
        ...
        public OperatorFormSingleNested(String PortName, String PortColor, Form MdiParent)
        {
            InitializeComponent();
            miniCommandControl1.Visible = false;
            MiniCommandControlSplitter.Visible = false;
            //For command button wrapping
            miniCommandControl1.AutoSize = false;
            miniCommandControl1.MaximumSize = new Size(630, 630);
        ...
        public Boolean CommandWindowVisible
        {
            ...
            set 
            {
                ...
                MiniCommandControlSplitter.Visible = value; 
            }
        }

        /// <summary>
        /// Gets or sets a value that indicates if the width of <see cref="MiniCommandControl">MiniCommandControl</see> is programatically increased based on the number/width of the commands in the container.
        /// </summary>
        [Browsable(true)]
        public Boolean AutoAdjustCommandWindowWidth
        {
            get { return miniCommandControl1.AutoAdjustWidth; }
            set { miniCommandControl1.AutoAdjustWidth = value; }
        }
        ...
        private void OperatorFormSingleNested_FormClosed(object sender, FormClosedEventArgs e)
        {
            Properties.Settings.Default.OpFormSingleHorizSplitter =
                splitContainer1.SplitterDistance;
            Properties.Settings.Default.OpFormSingleVertSplitter =
