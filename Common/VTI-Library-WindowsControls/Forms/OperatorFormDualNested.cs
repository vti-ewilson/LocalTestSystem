...
namespace VTIWindowsControlLibrary.Forms
{
    ...
    /// </summary>
    public partial class OperatorFormDualNested : Form
    {
        ...
        public OperatorFormDualNested(StringCollection PortNames, StringCollection PortColors, Form MdiParent)
        {
            InitializeComponent();
        ...
        /// <summary>
        /// Gets an array of the <see cref="ValvesPanelControl">TestHistory</see> controls for the form.
        /// </summary>
        [Browsable(false)]
        ...
        private void SetLeftTestHistorySize()
        {
            ...
            {
                testHistoryDockControl1.Rows = 5;
                testHistoryDockControl1.Columns = 3;
                testHistoryDockControl1.Caption = "Test History                                                                                                            Dock";
            }
        }
        ...
        private void SetRightTestHistorySize()
        {
            ...
            {
                testHistoryDockControl2.Rows = 5;
                testHistoryDockControl2.Columns = 3;
                testHistoryDockControl1.Caption = "Test History                                                                                                            Dock";
            }
        }
        ...
        private void OperatorFormDualNested_FormClosed(object sender, FormClosedEventArgs e)
        {
