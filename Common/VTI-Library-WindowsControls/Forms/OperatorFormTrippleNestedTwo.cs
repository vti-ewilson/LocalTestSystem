...
namespace VTIWindowsControlLibrary.Forms
{
    ...
    /// </summary>
    public partial class OperatorFormTrippleNestedTwo : Form
    {
        ...
        public OperatorFormTrippleNestedTwo(StringCollection PortNames, StringCollection PortColors, Form MdiParent)
        {
            InitializeComponent();
        ...
        private void OperatorFormTrippleNestedTwo_ResizeEnd(object sender, EventArgs e)
        {
